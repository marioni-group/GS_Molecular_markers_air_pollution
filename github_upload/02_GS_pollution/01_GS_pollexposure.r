...
#add Ids
ids <- data.frame(id = c("")) #substitute GS ID
...
#set latitude and longitudes for the individuals
...
pollutant_list <- c("SURF_ug_PM25_rh50", "SURF_ug_NO2", "SURF_ug_NO", 
                    "SURF_ppb_O3", "SURF_ug_PM10_rh50", "SURF_ug_SO2", 
                    "SURF_ug_NO3_C", "SURF_ug_NO3_F") 

#set start and end dates to collect data from 2005 to 2011
