...
#NB ****for htn analysis this df has to be filtered to remove prevalent HTN**** ----> see below
...
#(alternative table formats generated in /pollution_analysis/cox_models/CVD/02_cvd_covariate_prep.r)
