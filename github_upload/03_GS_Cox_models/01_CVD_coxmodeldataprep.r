...
gsappt <- fread("GS_appt.txt") #appointment dates for 24081
# simd <- fread("/Cluster_Filespace/Marioni_Group/Josie/Proteins/Pollution/EMEP4uk_gs/new_simd_data/2024-10-18_simd09_all_categories.csv") 
