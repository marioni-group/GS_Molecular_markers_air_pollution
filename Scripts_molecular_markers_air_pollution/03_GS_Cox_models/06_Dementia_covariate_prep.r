...
#From: scripts/pollution_analysis/cox_models/dementia/april_2025/02_dementiacox_df_prep_140425.r
...
#Following exploratory analysis, will knn impute missing covariates to avoid data loss and retain power (see *** script)
