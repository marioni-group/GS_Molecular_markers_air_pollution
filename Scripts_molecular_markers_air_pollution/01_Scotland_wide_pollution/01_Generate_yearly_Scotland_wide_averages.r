...
#1. Create yearly means of pollutants across Scotland

# Define list of pollutants and years 
...
file_list <- file_list[6:12] #select 2005 - 2011


#Function to generate yearly means for each pollutant
yearly_means <- function(pollutants, years) {
...
#save out
fwrite(results_df, file = "EMEP4uk/EMEP4UK_yearlysummary.csv")
